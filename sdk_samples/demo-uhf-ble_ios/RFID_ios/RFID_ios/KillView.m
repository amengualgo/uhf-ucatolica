...
-(instancetype)initWithFrame:(CGRect)frame
{
    if (self=[super initWithFrame:frame]) {
        ...
        _destoryBtn=[UIButton buttonWithType:UIButtonTypeCustom];
        [self addSubview:_destoryBtn];
        [_destoryBtn setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
        [_destoryBtn setTitle:@"Kill" forState:UIControlStateNormal];
        _destoryBtn.backgroundColor=RGB(210, 210, 210, 1);
        [_destoryBtn addTarget:self action:@selector(destoryBtnn) forControlEvents:UIControlEventTouchUpInside];
        [_destoryBtn mas_makeConstraints:^(MASConstraintMaker *make) {

...
public class ShapeLinearLayout extends LinearLayout {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mFillColor = typedArray.getColor(R.styleable.ShapeLinearLayout_sll_fillColor, mFillColor);
        mStrokeColor = typedArray.getColor(R.styleable.ShapeLinearLayout_sll_strokeColor, mStrokeColor);
        mStrokeWidth = typedArray.getDimensionPixelSize(R.styleable.ShapeLinearLayout_sll_strokeWidth, mStrokeWidth);
        mCornerRadius = typedArray.getDimensionPixelSize(R.styleable.ShapeLinearLayout_sll_cornerRadius, mCornerRadius);
        mCornerPosition = typedArray.getInt(R.styleable.ShapeLinearLayout_sll_cornerPosition, mCornerPosition);
        mStartColor = typedArray.getColor(R.styleable.ShapeLinearLayout_sll_startColor, mStartColor);
        mEndColor = typedArray.getColor(R.styleable.ShapeLinearLayout_sll_endColor, mEndColor);
        mOrientation = typedArray.getColor(R.styleable.ShapeLinearLayout_sll_orientation, mOrientation);
        typedArray.recycle();
    }
